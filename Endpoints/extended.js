 ...
 */
class RamApiExtended {
  /**
   * Create a new RamApiDemo instance.
   * @param {apikey} - The api key for the endpoints
   ...
   */
  constructor(apikey, retryAfter = 60000, retry = 3) {
    /** @private */
        ...
        setTimeout(async () => {
          ...
          try {
            const response = await axios({
              ...
              baseURL: baseURL,
              headers: _options.headers || { "api-key": this.apikey },
            });
